...
A CLI is also available as an RPM under releases, or you can just download and use it directly from source https://raw.github.com/tomakehurst/saboteur/master/cli/bbox.
...
``
    $ rpm -ivh https://github.com/tomakehurst/saboteur/releases/download/v0.2/saboteur-agent-0.2-1.noarch.rpm
``
